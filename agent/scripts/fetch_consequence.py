"""fetch_consequence.py — RSS fetcher for Consequence (consequence.net).

Big-tent indie/alt outlet. High natural overlap with Stereogum on US indie
releases — added 2026-05-23 to boost multi-source coverage on the bigger
weekly releases. News-style fetcher (artista="" extracted by classify).
"""
