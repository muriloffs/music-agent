"""fetch_paste_music.py — RSS fetcher for Paste Magazine's music section.

US indie/alt outlet focused on reviews. Added 2026-05-23 for the multi-
source push. News-style fetcher (artista="" extracted by classify).
"""
