"""fetch_fader.py — RSS fetcher for The FADER (thefader.com).

Indie + hip-hop + culture, US-based. Added 2026-05-23 for the multi-source
push. News-style fetcher (artista="" extracted by classify).
"""
...
SOURCE_ID = "fader"
FEED_URL = "https://www.thefader.com/feed"
