"""fetch_brooklyn_vegan.py — RSS fetcher for BrooklynVegan.

US indie/rock outlet, strong overlap with Stereogum on the same NY+US
indie scene. News-heavy with reviews mixed in. Added 2026-05-23 for the
multi-source push. News-style fetcher (artista="" extracted by classify).
"""
