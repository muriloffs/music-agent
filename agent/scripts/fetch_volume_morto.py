"""fetch_volume_morto.py — RSS fetcher for Volume Morto (BR).

Brazilian music newsletter covering releases, videos and texts on music.
Used to flag items as BR-origin for downstream bucket routing.
"""
...
SOURCE_ID = "volume_morto"
FEED_URL = "https://volumemorto.substack.com/feed"
